...
public class MainFrame extends JFrame {
    ...
    private void createMenuBar() {
        ...
        JMenuItem itemInserirListaPokemons = new JMenuItem("Insrir lista de Pokemon");
    ...
    private void inserirListaPokemons() throws SQLException {

        List<Pokemon> listPokemon =new ArrayList<>();
        Pokemon Pikachu = new Pokemon("Pikachu", "Eletrico", null, 21,23);
       listPokemon.add(Pikachu);

       pokemonController.inseriListaPokemons(listPokemon);
    }
