...
public class Conexao {
    ...
    public static void main(String[] args){
        ...
        atualizarDinossauro(1, "Joseph Joestar", "Dilophossauro", "Canibal", 30, 999, "Chefe de Obra");
    ...
    public static void atualizarDinossauro(int id, String nome, String especie, String dieta, int idade, int idadeEstimada, String status){
        String sql = "UPDATE dinossauro SET nome_Dinossauro = ?, especie_Dinossauro = ?, dieta_Dinossauro = ?, idade_Dinossauro = ?, idade_Estimada_Dinossauro = ?, status_Cercado = ? WHERE id_Dinossauro = ?";
        Connection conexao = Conexao.conectar();
        PreparedStatement stmt = null;
        ResultSet rs = null;
