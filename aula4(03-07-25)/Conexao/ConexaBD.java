...
public class ConexaBD {
    ...
    private static final String USUARIO = "root"; //o usuario que configura o banco
    ...
    public static void setAluno(String nome, int idade, String contato) {
        ...
        try {
            ...
            System.err.println("Erro ao inserir aluno no MySQL : " + e.getMessage());
        } finally {
            try {
    ...
    public static void main(String[] args) {
        Connection testeConexao = ConexaBD.conectar();
